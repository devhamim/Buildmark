                                ...
                                @foreach ($projects as $project)
                                    ...
                                    <div class="portfolio_item {{ $project_cat }}">
                                        <div class="grid-item-holder">
                                            <img  src="{{ asset('uploads/allgallery') }}/{{ $project->image }}"    alt="">

                                            <div class="grid-det">
                                                <div class="grid-det_category"><a href="{{ route('gallery.details', $project->id) }}">{{ $project->title }}</a></div>
                                                <div class="grid-det-item">
                                                    <a href="{{ route('gallery.details', $project->id) }}" class="ajax grid-det_link">{{ $project->address }}<i class="fal fa-long-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pr-bg"></div>
