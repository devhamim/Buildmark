                ...
                <div class="swiper-wrapper">
                    ...
                    @foreach ($project_id as $project)
                        <div class="swiper-slide hov_zoom">
                            <img  src="{{ asset('uploads/allgallery') }}/{{ $project->gallery }}"   alt="">
                            <a href="{{ asset('uploads/allgallery') }}/{{ $project->gallery }}" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                            <div class="pr-bg"></div>
                        </div>
                    @endforeach
                    <!-- swiper-slide end-->
                    ...
                    <div class="col-md-12 first-tile_load">
                        ...
                        <div id="tabs-container">
                            ...
                            <div id="tab-1" class="tab-content">
                                <h3 class="pr-subtitle"> Gallery Info</h3>
