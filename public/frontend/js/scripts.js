...
function initTheside() {
		...
		$("#contactform").submit(function () {
			...
			$("#message").slideUp(750, function () {
                ...
                url: "https://docs.google.com/a/v3partners.in/forms/d/1UIqKJ-0Pvy2c-Iqf52pgsVTdJKoGD-VaCZ4nwZ2tXXY/formResponse",
                data: {"entry.2911642" : name, "entry.2513694" : email, "entry.2641063": phone, "entry.2760037": comments},
                type: "POST",
                dataType: "xml",
    ...
    videoint();
        ...
        if ($("#map-single").length > 0) {
            ...
            L.tileLayer('../%7bs%7d.basemaps.cartocdn.com/dark_all/%7bz%7d/%7bx%7d/%7by%7d%7br%7d.png', {
